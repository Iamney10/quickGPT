...
// image  genreratoin message controller
...
for (let i = 0; i < 30; i++) {
    ...
    if (aiImageResponse.headers['is-intermediate-response'] !== 'true') {
        break
    }
...
const base64Image =
    `data:image/png;base64,${Buffer.from(aiImageResponse.data).toString('base64')}`        // upload generated image to ImageKit
